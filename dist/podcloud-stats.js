;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["podcloud-stats"] = factory()
  else root["podcloud-stats"] = factory()
  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        const ISSUERS_KEYS_PATH = _path2.default.resolve(
          __dirname,
          "./issuers_keys"
        )
        ...
        const decodePayload = payload => {
          ...
          if (!decoded)
            throw new _Errors.InvalidPayloadError("Could not decode payload")
          if (!decoded.iss)
            throw new _Errors.InvalidIssuerPayloadError(
        ...
        const checkAndGetIssuerKeyPath = payload => {
          ...
          const issuer_key_path = _path2.default.join(
            ISSUERS_KEYS_PATH,
            decoded.iss + ".pem"
          )
          try {
            _fs2.default.accessSync(
              issuer_key_path,
              _fs2.default.constants.R_OK
            )
          } catch (err) {
            throw new _Errors.InvalidIssuerPayloadError(
        ...
        const verifyPayload = payload => {
          ...
          try {
            ...
            if (
              ...
              throw new _Errors.InvalidPayloadError(
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        const validRefererOrDefault = (referer, defaultValue = null) => {
          try {
            return (0, _index.notEmpty)(referer)
              ? _url2.default.parse(referer.trim()).href
              : defaultValue
          } catch (e) {
            return defaultValue
          }
        ...
        const validNotEmptyOrDefault = (value, defaultValue = "na") =>
          (0, _index.notEmpty)(value) ? value : defaultValue
        ...
        let _GEOLITE_PATH = _path2.default.join(
          __dirname,
          (true ? "../src/Appeals" : ".") + "/geoip/GeoLite2-City.mmdb"
        )
        ...
        PodcastViewAppeal.process = payload => {
          return new Promise((resolve, reject) => {
            if (typeof PodcastViewAppeal[MAXMIND] !== "object") {
              PodcastViewAppeal[MAXMIND] = _maxmind2.default.openSync(
                _GEOLITE_PATH
              )
            }
